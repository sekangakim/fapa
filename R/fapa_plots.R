...
plot_fapa_core <- function(bca, i = 1, split_at = 11,
  ...
  plot(s$Ori[idx_before], type = "b", lty = 2, lwd = 2,
       ...
       main = main, xaxt = "n")
  axis(1, at = seq_along(idx_before),
...
#'
#' @param bca    A list returned by \code{\link{fapa_bca}}.
#' @param Xtilde Numeric matrix (persons × variables), ipsatized.
...
#' @param cc_thresh Numeric. Fair-similarity reference line. Default \code{0.85}.
#'
#' @return Invisibly returns \code{NULL}.
#' @export
